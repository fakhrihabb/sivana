    ...
    <div className="min-h-screen gradient-bg pt-16">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="mt-2">
            <p className="text-gray-600 mb-3">{formasi.lembaga}</p>
            ...
            {formasi.kantorPusat && (
              <div className="flex items-center gap-2 mb-2 text-sm text-gray-600">
                ...
                <span>Kantor Pusat: <span className="font-medium">{formasi.kantorPusat}</span></span>
              </div>
            )}
            ...
            {formasi.locations && formasi.locations.length > 0 && (
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-xs text-gray-500 font-medium mb-1">Lokasi Penempatan:</p>
                  <div className="flex flex-wrap gap-2">
                    {formasi.locations.map((location, index) => (
                      <span 
                        key={index}
